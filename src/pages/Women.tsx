...
const Women = () => {
  ...
  const femaleModels = [
    ...
    { id: 12, name: "Mebiame Ayito Kendra", image: "https://i.ibb.co/tTvXMhHd/480117172-617772584194014-439744238002598291-n.jpg" },
    ...
    { id: 23, name: "Noémi Kim", image: "https://i.ibb.co/4ncX4Brk/481054309-617829164434762-185712014482056867-n.jpg" },
