              ...
              <div className='bg-white/10 border border-white/20 rounded-2xl p-6'>
                ...
                <form onSubmit={handleSaveContest} className='space-y-5'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div><label className='block text-white/70 text-sm mb-1'>Nom *</label><input type='text' value={contestForm.name} onChange={e=>setContestForm({...contestForm,name:e.target.value})} className={inp} placeholder='Nom du concours' autoFocus/></div>
