      ...
      {value && (
        <div className="relative group w-full">
          ...
          <button
            type="button"
            onClick={() => onChange('')}
            className="absolute top-2 right-2 bg-black/70 rounded-full p-1 text-white/60 hover:text-red-400 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none transition-opacity"
