          ...
          {values.map((url, i) => (
            <div key={i} className="relative group aspect-square">
              ...
              <button
                type="button"
                onClick={() => removeUrl(i)}
                className="absolute top-1 right-1 bg-black/70 rounded-full p-0.5 text-white/60 hover:text-red-400 opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none transition-opacity"
