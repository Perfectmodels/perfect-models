...
const navigation: NavigationSection[] = [
  ...
  { title: 'Talents', items: [
    ...
    { to: '/admin/talent-search', label: 'Smart Talent Search', icon: MagnifyingGlassIcon, description: 'Langage naturel, mensurations, look et disponibilité', permission: 'models' },
    { to: '/admin/comp-cards', label: 'Comp Cards', icon: PhotoIcon, description: 'Cartes mannequins et export PDF', permission: 'models' },
